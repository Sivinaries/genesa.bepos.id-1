            ...
            <div
                ...
                <div>
                    <h1 class="font-bold text-2xl text-gray-800 flex items-center gap-2">
                        <i class="fa-solid fa-coins text-green-500 text-4xl"></i> Settlement Management
                    </h1>
                    <p class="text-sm text-gray-500 mt-1">Manage your cashier shift settlements</p>
                </div>
                <div class="flex gap-2">
                    <button id="startBtn"
                        class="px-6 py-3 text-base bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 transition font-bold flex items-center gap-2">
                    ...
                    <div class="p-12 text-center">
                        <div class="flex flex-col items-center justify-center opacity-70">
                            ...
                            <button id="emptyStartBtn"
                                class="px-6 py-2.5 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 hover:scale-105 transition font-bold flex items-center gap-2 text-sm">
