            ...
            <div
                ...
                <div>
                    <h1 class="font-bold text-2xl text-gray-800 flex items-center gap-2">
                        <i class="fa-solid fa-qrcode text-gray-800 text-4xl"></i> Barcode Management
                    </h1>
                    <p class="text-sm text-gray-500 mt-1">Organize and manage your QR barcodes</p>
                </div>
                <x-button id="addBtn" size="lg" variant="gray" icon="plus">Add</x-button>
            </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        ...
                                        <td class="p-4">
                                            <div class="flex justify-center items-center gap-2">
                                                ...
                                                <form method="post" action="{{ route('delchair', ['id' => $item->id]) }}"
