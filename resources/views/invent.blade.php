...
<body class="bg-gray-50 font-sans">
            ...
            <div
                ...
                <div>
                    <h1 class="font-bold text-2xl text-gray-800 flex items-center gap-2">
                        <i class="fa-solid fa-receipt text-purple-500 text-4xl"></i> Master Ingridient
                    </h1>
                    <p class="text-sm text-gray-500 mt-1">Organize and manage your master ingredients</p>
                </div>
                ...
                <div class="w-full bg-white rounded-xl shadow-md border border-gray-100">
                    <div class="p-12 text-center">
                        <div class="flex flex-col items-center justify-center opacity-70">
                            ...
                            <h3 class="text-lg font-bold text-gray-900">No master ingredients yet</h3>
    ...
    <script src="{{ asset('modal/mast.js') }}"></script>

    <!-- Modals -->
    @include('modal.addMaster')
    @include('modal.editMaster')
